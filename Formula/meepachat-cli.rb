...
class MeepachatCli < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/bogpad/meepa/releases/download/v0.1.0/meepa-cli_0.1.0_darwin_arm64.tar.gz"
      sha256 "d7c3f049729e4cf433964d5a670bcfe4fb883ceb41dc320d894794f9be4c9d66"
    end

    on_intel do
      url "https://github.com/bogpad/meepa/releases/download/v0.1.0/meepa-cli_0.1.0_darwin_amd64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/bogpad/meepa/releases/download/v0.1.0/meepa-cli_0.1.0_linux_arm64.tar.gz"
      sha256 "e0d755b775a18caf41f7e64c0520214604a4185a36cccd95fec20011bfcc394a"
    end

    on_intel do
      url "https://github.com/bogpad/meepa/releases/download/v0.1.0/meepa-cli_0.1.0_linux_amd64.tar.gz"
